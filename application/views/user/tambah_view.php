                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="lahir" required="required" placeholder="Contoh : Sragen">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>Telepon</label>
                                        <input id="uintTextBox" class="form-control" name="telepon" placeholder="Tidak Wajib">
                                    </div>
                                    <div class="form-group">
                                        <label>E-mail</label>
                                        <input type="email" class="form-control" name="email" placeholder="Tidak Wajib">
                                    </div>
                                    <div class="form-group">
