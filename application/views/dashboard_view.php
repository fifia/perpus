          ...
          <div class="col-lg-3 col-md-4 col-sm-12">
            <div class="card mb-20">
              <div class="card-body">
                ...
                <p class="card-text display-1 text-center text-lime"><?= $count_pengguna; ?></p>
          ...
          <div class="col-lg-3 col-md-4 col-sm-12">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text display-1 text-center text-violet"><?= $count_buku; ?></p>
                <div class="card-footer">
          ...
          <div class="col-lg-3 col-md-4 col-sm-12">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text display-1 text-center text-success"><?= $count_pinjam; ?></p>
                <div class="card-footer">
          ...
          <div class="col-lg-3 col-md-4 col-sm-12">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text display-1 text-center text-pumpkin"><?= $count_kembali; ?></p>
                <div class="card-footer">
